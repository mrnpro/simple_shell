...
/**
 * cd_b -   the current working   to the parameter passed to cd.
 * if no parameter is   it will change directory to HOME.
 * @line: A string representing the   from the user.
 */
void cd_b(char *line)
{
	int index;
...
/**
 * env_b - Prints all the env   variables in the current shell.
...
/**
 * exit_b - Exits the  . After freeing allocated resources.
 * @line: A string representing the input from the user.
 */
